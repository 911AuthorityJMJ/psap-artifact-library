...
export const FIELDS = [
    ...
    {
        id: "directorName",
        label: "Director / Coordinator",
        type: "text",
        shared: true,
        placeholder: "a role, e.g. PSAP Director — not a person’s name",
        aliases: [
            "director / coordinator",
            "the director",
            "director",
            "director / coordinator or designated adjudicating authority",
        ],
    },
    {
        id: "directorEmail",
        ...
        type: "text",
        autoFill: "directorEmail",
        shared: true,
        aliases: [],
    }, // no bracket in corpus; autofill only
    {
        id: "signingOfficialTitle",
        label: "Signing Official & Title",
        type: "text",
        shared: true,
        placeholder: "e.g. Jane Smith, PSAP Director",
        aliases: ["signing official / title", "signing official"],
    },
    ...
    },
    {
        ...
        aliases: ["role"],
    }, // broad token; per-table it may be a loop column — override in LoopDefs
    {
        id: "approvingOfficialTitle",
        label: "Approving Official & Title",
        type: "text",
        shared: true,
        placeholder: "e.g. County Manager",
        aliases: ["approving official / title"],
    },
    {
        id: "revisionNote",
        label: "Initial Revision Note",
        type: "text",
        shared: true,
        placeholder: "Initial issue",
        aliases: ["initial issue"],
    },
    ...
    {
        id: "allPersonnel",
        label: "All Personnel (scope)",
        type: "text",
        placeholder: "e.g. All telecommunicators and staff",
        aliases: ["all personnel"],
    },
    {
        id: "itSupport",
        label: "IT Support Model",
        type: "select",
        options: ["County IT", "Vendor", "In-house"],
        aliases: [
            "it support (county / vendor / in-house)",
            "it support",
            "it provider: county it / contractor / in-house",
        ],
    }, // composite: options curated by hand, NOT '/'-split
    {
        id: "period",
    ...
    },
    {
        ...
        aliases: [
            "dispatch supervisor",
            "dispatch supervisor or operations lead",
    ...
    {
        id: "systemOwnerRole",
        label: "System Owner (role)",
        type: "text",
        aliases: ["system owner (role)", "system owner role", "system / data owner"],
    },
    {
        id: "securityReviewerRole",
        label: "Security Reviewer (role)",
        type: "text",
        aliases: [
            "security reviewer (role)",
            "security reviewer",
            "security coordinator / log reviewer",
        ],
    },
    ...
    {
        id: "reviewedByRole",
        label: "Reviewed By (role)",
        type: "text",
        aliases: ["reviewed by (role)"],
    },
    {
        id: "preparedByRole",
        label: "Prepared By (role)",
        type: "text",
        aliases: ["prepared by (role)"],
    },
    {
        id: "recordedByRole",
        label: "Recorded By (role)",
        type: "text",
        aliases: ["recorded by (role)"],
    },
    {
        id: "acknowledgedByRole",
        label: "Acknowledged By (Board / leadership chair)",
        type: "text",
        aliases: ["acknowledged by (board / leadership chair)"],
    },
    {
        id: "chairRole",
        label: "Chair / Presiding Official",
        type: "text",
        aliases: ["chair / presiding official"],
    },
    {
        id: "authorizingOfficialTitle",
        label: "Authorizing Official & Title",
        type: "text",
        aliases: ["authorizing official / title"],
    },
    {
        id: "authorizedRepresentative",
        label: "Authorized Representative",
        type: "text",
        aliases: ["authorized representative"],
    },
    {
        id: "boardLeadershipBody",
        label: "Board / Leadership Body",
        type: "text",
        aliases: ["board / leadership body", "the board / leadership"],
    },
    {
        id: "facilityAdmin",
        label: "Facility / Access Administrator",
        type: "text",
        aliases: ["facility / access administrator"],
    },
    {
        id: "hrTrainingCoordinator",
        label: "HR / Training Coordinator",
        type: "text",
        aliases: [
            "hr / training coordinator",
            "hr / training coordinator role",
            "training / security coordinator",
        ],
    },
    {
        id: "dataGovernanceRole",
        label: "Data Governance Role",
        type: "text",
        aliases: ["data governance role"],
    },
    {
        id: "changeApproverRole",
        label: "Change Approver / Advisory Role",
        type: "text",
        aliases: ["change approver / advisory role"],
    },
    {
        id: "itLead",
        label: "County IT / Vendor Lead",
        type: "text",
        aliases: ["county it or vendor lead", "county or contracted it lead"],
    },
    {
        id: "location",
        label: "Location",
        type: "text",
        aliases: ["location", "room / video bridge"],
    },
    { id: "startTime", label: "Start Time", type: "text", aliases: ["start"] },
    { id: "endTime", label: "End Time", type: "text", aliases: ["end"] },
    {
        id: "assetId",
        label: "Asset ID (Master Asset Inventory)",
        type: "text",
        aliases: ["id from master asset inventory"],
    },
    { id: "systemName", label: "System Name", type: "text", aliases: ["system name"] },
    {
        ...
        type: "text",
        aliases: ["vendor", "vendor name", "vendor / contractor name", "vendor / product name"],
    },
    {
        id: "fullName",
        label: "Full Name",
        type: "text",
        aliases: ["full name", "full name of person acknowledging", "acknowledging individual"],
    },
    {
        id: "partyA",
        label: "Party A (Agency)",
        type: "text",
        aliases: ["party a", "party a (agency)"],
    },
    {
        id: "partyB",
        label: "Party B (Vendor)",
        type: "text",
        aliases: ["party b", "party b (vendor)"],
    },
    {
        id: "riskRef",
        label: "Risk / POA&M Reference",
        type: "text",
        placeholder: "RISK-### / POA&M-###",
        aliases: ["risk ref", "risk-### / poa&m-###"],
    },
    { id: "changeRef", label: "Change Reference", type: "text", aliases: ["change ref"] },
    {
        id: "allowedTraffic",
        label: "Allowed Traffic / ACL Summary",
        type: "textarea",
        aliases: ["allowed traffic / acl summary"],
    },
    ...
    },
    {
        ...
        aliases: ["quarterly", "annually", "monthly", "weekly"],
    },
    {
        id: "conformance",
        label: "Conformance",
        type: "select",
        options: ["Conforms", "Gap", "N/A"],
        aliases: ["conforms / gap / n/a"],
    },
    {
        id: "statusOpen",
        label: "Status",
        ...
        aliases: ["open / in progress / closed", "open / in progress", "open"],
    },
    {
        id: "environment",
        label: "Environment",
        type: "select",
        options: ["Production", "Test", "DR"],
        aliases: ["production / test / dr"],
    },
    {
        id: "hostingModel",
        label: "Hosting Model",
        type: "select",
        options: ["On-prem", "Cloud", "Site"],
        aliases: ["on-prem / cloud / site"],
    },
    {
        id: "implementationStatus",
        label: "Implementation Status",
        type: "select",
        options: ["In place", "Partial", "Planned"],
        aliases: ["in place / partial / planned"],
    },
    {
        id: "currentDue",
        label: "Current / Due",
    ...
    },
    {
        ...
        label: "Criticality",
        type: "select",
        options: ["Critical", "Important", "Supporting"],
        aliases: ["critical / important / supporting: from the asset criticality ranking matrix"],
    },
    ...
    // Temporary]" bracket is the decision; the temporary end date is its own field.
    {
        ...
        aliases: ["permanent / temporary", "permanent or temporary"],
    },
    ...
    // Enum choices that had been left literal → dropdowns.
    {
        ...
        type: "select",
        options: ["ESInet re-route", "Ten-digit transfer", "Radio patch"],
        aliases: ["the agreed method: esinet re-route, ten-digit transfer, or radio patch"],
    }, // A-021
    {
        id: "mfaMethod",
        label: "MFA Method",
        type: "select",
        options: ["Authenticator app", "Hardware token", "One-time code"],
        aliases: ["authenticator app / hardware token / one-time code"],
    }, // A-040
    {
        id: "deviceClass",
        label: "Device Class",
        type: "select",
        options: ["General endpoint", "Email server", "VoIP or multimedia server"],
        aliases: ["general endpoint / email server / voip or multimedia server"],
    }, // A-119
    {
        id: "timeSourceType",
        label: "Time Source Type",
        type: "select",
        options: ["Internal NTP", "GPS", "External NTP"],
        aliases: ["internal ntp / gps / external ntp"],
    }, // A-138
    // Genuine fill-in prompts that had been left literal → labeled fields.
    {
        ...
        type: "textarea",
        aliases: [
            "name the public-safety systems in scope: cad, esinet/ngcs, radio, ali/gis, recording, network",
        ],
    }, // A-008
    {
        id: "alternateSiteLocationAndSetup",
        label: "Alternate Site Location and Setup",
        type: "textarea",
        aliases: ["location, and how call taking and dispatch are stood up there"],
    }, // A-019
    {
        id: "mobileOrFallbackOption",
        label: "Mobile or Fallback Option",
        type: "text",
        aliases: ["mobile command unit or radio dispatch, if any"],
    }, // A-019
    {
        id: "excludedSystems",
        ...
        type: "textarea",
        aliases: [
            "systems another agency owns and backs up under a separate agreement. if none, state none",
        ],
    }, // A-022
    {
        id: "providersAndAssessmentPeriod",
        label: "Providers and Assessment Period",
        type: "textarea",
        aliases: ["providers assessed and period; itemize in the providers assessed table below"],
    }, // A-076
    {
        id: "vendorServiceType",
        label: "Service",
        type: "text",
        aliases: ["cad / gis / voip / cloud storage"],
    }, // A-076
    {
        id: "monitoringMethod",
        label: "Monitoring Method",
        type: "text",
        aliases: ["vendor soc report / posture tool / attestations / advisories"],
    }, // A-076
    {
        id: "toolMethodology",
        label: "Tool / Methodology",
        type: "textarea",
        aliases: ["scanner, authenticated scan, or penetration test; rules of engagement"],
    }, // A-081
    {
        id: "deliveryMethods",
        ...
        type: "textarea",
        aliases: [
            "methods, for example short online modules, briefings at shift change, tabletop participation, and phishing simulations",
        ],
    }, // A-086
    {
        id: "completionTargets",
        label: "Completion Targets",
        type: "textarea",
        aliases: [
            "for example, all staff complete annual awareness training; new hires complete the baseline before system access is granted",
        ],
    }, // A-086
    {
        id: "dataSensitivity",
        ...
        type: "textarea",
        aliases: [
            "classification tier(s) the system handles: from the data classification policy; note if cjis-regulated data is in scope",
        ],
    }, // A-092
    {
        id: "ntpServiceAndVersion",
        label: "NTP Service and Version",
        type: "textarea",
        aliases: ["service and version, on all synchronized hosts"],
    }, // A-138
    {
        id: "failoverBehavior",
        label: "Failover Behavior",
        type: "textarea",
        aliases: ["automatic to gps or secondary; holdover period"],
    }, // A-138
    {
        id: "cadPrimaryAndCounterpart",
        label: "CAD Primary and Counterpart",
        type: "text",
        aliases: ["primary cad; backup cad or manual procedures"],
    }, // A-143
    ...
    {
        id: "personnelCorrectiveActionProcess",
        label: "Personnel Corrective Action Process",
        type: "text",
        aliases: ["personnel corrective action process"],
    },
    {
        id: "completedByRole",
        label: "Completed By (role)",
        type: "text",
        aliases: ["completed by role"],
    },
    ...
    // ── Corpus-complete ambiguous triage (adversarially verified) ────────────
    {
        ...
        label: "Severity",
        type: "select",
        options: ["High", "Med", "Low", "NA"],
        aliases: ["high / med / low / na"],
    }, // A-060
    {
        id: "remoteAccessMethod",
        label: "Remote-Access Method",
        type: "select",
        options: ["Staff VPN", "Vendor support session", "Virtual desktop"],
        aliases: ["remote-access method: staff vpn / vendor support session / virtual desktop"],
    }, // A-115
    {
        id: "scopeOfReview",
        ...
        type: "textarea",
        aliases: [
            "the incident or exercise reviewed, and the incident log / register entry it draws from",
        ],
    }, // A-060
    {
        ...
        type: "text",
        aliases: ["incident id or incident log / register entry"],
    }, // A-063
    {
        id: "hostEscort",
        label: "Host / Escort",
        type: "text",
        aliases: ["staff member or role hosting and escorting the visit"],
    }, // A-072
    {
        id: "mailSecuritySystem",
        label: "Mail Security System",
        type: "text",
        aliases: ["mail filtering gateway / hosted mail-security service"],
    }, // A-111
    {
        id: "alertTriggersAndRouting",
        label: "Alert Triggers and Routing",
        type: "textarea",
        aliases: ["what raises an alert; where it goes"],
    }, // A-111
    {
        id: "continuousMonitoring",
        label: "Continuous / Automated Monitoring",
        type: "textarea",
        aliases: ["what is watched in real time or near real time, by which tool"],
    }, // A-133
    {
        id: "periodicReviewCadence",
        label: "Periodic Review Cadence & Coverage",
        type: "textarea",
        aliases: ["daily alert review, weekly log review, and what each covers"],
    }, // A-133
    {
        id: "sourcesAndPeriodReviewed",
        label: "Sources and Period Reviewed",
        type: "textarea",
        aliases: ["log and monitoring sources, and the time span"],
    }, // A-137
    {
        id: "anomaliesReviewed",
        label: "Anomalies Reviewed",
        type: "textarea",
        aliases: ["anomalies reviewed and how each was investigated"],
    }, // A-137
    {
        id: "forensicExaminer",
        ...
        type: "text",
        aliases: [
            "who conducts forensics, whether an internal analyst, county or vendor it, or a contracted firm",
        ],
    }, // A-141
    {
        id: "evidenceStorageLocation",
        label: "Evidence Storage Location",
        type: "textarea",
        aliases: [
            "where evidence is held so it cannot be altered: a locked, access-controlled location or a sealed digital store",
        ],
    }, // A-141
    {
        id: "evidenceAuthorizingOfficial",
        label: "Authorizing Official",
        type: "text",
        aliases: ["who may authorize collection, isolation, and release of evidence"],
    }, // A-141
    {
        id: "poweredLoads",
        label: "Powered Loads",
        type: "textarea",
        aliases: ["what it powers in an extended outage"],
    }, // A-147
    {
        id: "trainingDeliveryMethods",
        label: "Delivery Methods",
        type: "textarea",
        aliases: [
            "methods, for example a short online module, a briefing at shift change, a vendor-led session, or a supervised walkthrough on the system itself",
        ],
    }, // A-162
];
...
export const LOOPS = [
    ...
    },
    {
        ...
        id: "accessEntitlements",
        label: "Access Entitlement Rows",
        proposed: false,
        maxRows: 100,
    ...
    },
    {
        ...
        fields: [
            { id: "party", label: "System or Party", type: "text", aliases: ["system or party"] },
            {
                ...
                type: "text",
                aliases: ["inbound / outbound / both: what data"],
            },
            {
                id: "protocolPort",
                label: "Protocol / Port",
                type: "text",
                aliases: ["protocol / port"],
            },
            {
                id: "connectionType",
    ...
    {
        id: "controls",
        label: "Control implementation rows",
        proposed: true,
        maxRows: 60,
    ...
    {
        id: "leadershipDecisions",
        label: "Leadership decision rows",
        proposed: true,
        maxRows: 30,
        ...
        fields: [
            {
                ...
                label: "Decision Item",
                type: "text",
                aliases: ["decision or priority", "decision"],
            },
            { id: "ownerRole", label: "Owner", type: "text", aliases: [] },
            { id: "action", label: "Action", type: "textarea", aliases: ["action"] },
    ...
    },
    {
        ...
        fields: [
            ...
            { id: "action", label: "Remediation", type: "textarea", aliases: ["action"] },
            {
                ...
                type: "select",
                options: ["Open", "In progress", "Closed"],
                aliases: ["open / in progress / closed", "open / in progress"],
            },
            { id: "date", label: "Date", type: "date", aliases: ["date"] },
        ],
    },
    ...
    {
        id: "coLocation",
        label: "Co-location / equipment rows",
        proposed: true,
        maxRows: 30,
        ...
        fields: [
            ...
            {
                id: "otherParty",
                label: "Other Agency / Dept",
                type: "text",
                aliases: ["other agency / department"],
            },
            {
                id: "coLocationRisk",
                label: "Co-location Risk",
                type: "textarea",
                aliases: ["risk from co-location"],
            },
            {
                id: "compensatingControl",
                label: "Compensating Control",
                type: "textarea",
                aliases: ["compensating control"],
            },
        ],
    },
    {
        id: "assessmentItems",
        label: "Hardening assessment rows",
        proposed: true,
        maxRows: 60,
...
export const INSTRUCTIONAL = [
    ...
    "add agency-specific requirements.",
    "add agency-specific roles",
    "add agency-specific rules.",
    "add agency-specific statements.",
    "add agency-specific systems.",
    'add exclusions if any; if none, write "none."',
    ...
    "appendix a / the vendor & contractor inventory entry",
    "approve resources for x?",
    ...
    "background check; audit training",
    "background check; incident-response training",
    "background check; monitoring and detection training",
    "badge + pin; authorized staff only",
    "badge; authorized staff only",
    "cad / call-handling workstations",
    "cad / esinet servers; core network",
    ...
    "date the tier and impacts were last confirmed",
    "define approved device types.",
    "directory groups / application roles / local groups",
    "directory, application, or local accounts",
    "dispatch floor",
    "e.g., 1 business day",
    "e.g., 1 hour",
    "e.g., 30 minutes, 24/7",
    "e.g., 4 hours",
    "e.g., 72 hours",
    "e.g., escalation to provider management",
    ...
    "e.g., vendor outage, compromised update, single-carrier dependency",
    "e.g., weekly",
    "emerging threats or intelligence briefed to leadership",
    "exclusions, if any",
    'exclusions, if any; if none, write "none."',
    "executive summary.",
    ...
    "from the poa&m",
    "highest-rated open risks",
    "how it is implemented; reference the governing policy",
    "idf / mdf closets; cable pathways",
    "if applicable",
    "inbound / outbound / both: what data",
    "independent of day-to-day operations",
    "iot reports under hea 1169, if any",
    ...
    "role / title; mark employee or contractor",
    "screening & training",
    "senior official, e.g., agency director or county liaison",
    "server room / equipment area",
    "setting, e.g., logging",
    "setting, e.g., open/closed ports",
    "setting, e.g., password rules",
    "significant change to the agency's systems or change process",
    "staff badge",
    "state the committed budget line or allocation, or reference where it is set.",
    "stated minimum security practices",
    "stated service",
    "summary of where the program stands",
    "supervisor / hr: verified complete",
    ...
    "the executive sponsor or the county board",
    "top risks and any change in priority",
    "zone, e.g., dispatch vlan",
];
